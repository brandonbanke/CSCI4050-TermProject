...
-- Dump completed on 2021-10-20 13:43:58
-- MySQL dump 10.13  Distrib 8.0.27, for Win64 (x86_64)
--
-- Host: 127.0.0.1    Database: cbs
-- ------------------------------------------------------
...
CREATE TABLE `booking` (
  ...
  KEY `cardId` (`cardId`),
  CONSTRAINT `booking_ibfk_1` FOREIGN KEY (`customerEmail`) REFERENCES `customer` (`email`),
...
-- Dump completed on 2021-10-20 13:43:57
-- MySQL dump 10.13  Distrib 8.0.27, for Win64 (x86_64)
--
-- Host: 127.0.0.1    Database: cbs
-- ------------------------------------------------------
...
-- Dump completed on 2021-10-20 13:43:59
-- MySQL dump 10.13  Distrib 8.0.27, for Win64 (x86_64)
--
-- Host: 127.0.0.1    Database: cbs
-- ------------------------------------------------------
