<?php
    ...
    if (!isset($couponcode)) {
        $couponcode = filter_input(INPUT_GET, 'coupon');
                    ...
                    <div class="totals">
                        ...
                        <div class="grand-total">
                            ...
                            <form action="./checkout.php" method = "POST">
                                <input class = "coupon" type="hidden" name="couponBool" id="couponBool" value = "<?php echo $shipping ?>">
                                <input class="btn" type = "submit" id = "button" value = "Checkout">
                            </form>
                                <button class="continue-shopping" onclick="window.location.href='./header.php'">Add Items</button>
                        </div>
                        <form action="?coupon=<?php echo $couponcode; ?>" method="GET" onsubmit="return applyCoupon();">
                            <br>
